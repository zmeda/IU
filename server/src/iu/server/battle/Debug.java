...
public final class Debug
{
	...
	public static void redirectLucas (String file)
	{
	...
	private static PrintStream fileStream (String file)
	{
		try
		{
	...
	public static class WindowOutput extends OutputStream
	{
		...
		WindowOutput (String name, int buffer_size, boolean out)
		{
	...
	public static class GraphicOutput extends Canvas
	{
		 ...
		 * 
		 */
		private static final long	serialVersionUID	= -726105559265945213L;
		...
		public GraphicOutput (String title, int graphicsWidth, int graphicsHeight, boolean output)
		{
